...
import { Menu, X, LogOut, User as UserIcon, Settings, ChevronDown, BarChart2, Gamepad2, User } from 'lucide-react';
              ...
              <div className="ml-10 flex items-center space-x-2">
                ...
                {user && (
                  <>
                    ...
                    {user.role === 'admin' && (
                      <Link to="/new-players" className={`${isActive('/new-players')} px-4 py-2 rounded-full text-sm font-bold transition-all duration-300 flex items-center gap-1`}>
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              {user ? (
                <>
                  ...
                  {user.role === 'admin' && (
                    <Link to="/new-players" onClick={() => setMobileMenuOpen(false)} className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-elkawera-green">New Players</Link>
                  )}

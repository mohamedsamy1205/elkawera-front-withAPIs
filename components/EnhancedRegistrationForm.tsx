          ...
          <div className="flex items-center justify-between text-xs">
            ...
            <div className="flex gap-3">
              <div className={`flex items-center gap-1 ${
                touched.email && !errors.email ? 'text-green-400' : 'text-gray-500'
              }`}>
                {touched.email && !errors.email ? <Check size={12} /> : <X size={12} />}
                Gmail
              </div>
              <div className={`flex items-center gap-1 ${
                touched.phone && !errors.phone ? 'text-green-400' : 'text-gray-500'
              }`}>
                {touched.phone && !errors.phone ? <Check size={12} /> : <X size={12} />}
                11-digit Phone
              </div>
              <div className={`flex items-center gap-1 ${
                touched.password && !errors.password ? 'text-green-400' : 'text-gray-500'
              }`}>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full bg-black/50 border rounded-xl p-4 text-white focus:outline-none transition-colors pr-10 ${
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full bg-black/50 border rounded-xl p-4 text-white focus:outline-none transition-colors pr-20 ${

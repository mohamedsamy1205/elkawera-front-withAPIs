...
export const SignUp: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newUser = await signUp(name, email, password, age, height, weight, strongFoot, position);
    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
      <div className="w-full max-w-md bg-white/5 border border-white/10 rounded-3xl p-8 shadow-2xl backdrop-blur-sm animate-fade-in-up">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-2">Register as a player to get your card created by admins.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            <UserPlus size={20} /> Register as Player
          </button>
        </form>
